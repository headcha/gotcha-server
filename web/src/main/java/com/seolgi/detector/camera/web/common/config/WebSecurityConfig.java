...
import com.seolgi.detector.camera.web.common.auth.*;
import com.seolgi.detector.camera.web.common.config.cookie.CustomCookieSerializer;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	public AuthenticationFailureHandler failureHandler() {
		...
		authFailHandler.setDefaultFailureUrl("/account/signin");
